        ...
        <div class="login">
            <form action="" method="post" name="login">
                <fieldset>
                    ...
                    <input type="text" name="userid" placeholder="Username: admin" autocomplete="off" required>
                    <input type="password" name="password" placeholder="Password: 123" autocomplete="off" required>
